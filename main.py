...
# --- EXTREME CLIENT SETUP (FIXED - No Invalid Parameters) ---
user_client = TelegramClient(
    StringSession(STRING_SESSION), 
    API_ID, 
    API_HASH,
    connection=connection.ConnectionTcpFull,
    use_ipv6=False,  # Force IPv4 for Render
    connection_retries=None,
    flood_sleep_threshold=120,  # Aggressive flood handling
    request_retries=20,  # More retries for stability
    auto_reconnect=True
)
